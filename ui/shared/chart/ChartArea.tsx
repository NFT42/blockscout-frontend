...
const ChartArea = ({ id, xScale, yScale, color, data, disableAnimation, ...props }: Props) => {
  ...
  const defaultGradient = {
    startColor: useToken('colors', useColorModeValue('stealthtest.purple', 'stealthtest.purple')),
    stopColor: useToken('colors', transparentize(useColorModeValue('stealthtest.purple', 'stealthtest.purple'), 0)(theme)),
  };
